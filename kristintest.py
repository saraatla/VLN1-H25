...
answer = input("Do you want to repeat this work request?")
...
date__ = date_.split('/')
x = datetime(int(date__[2]),int(date__[1]),int(date__[0]))
if date.today() < x:
    ...
    # create_work_request()
        ...
        how_many = input('for how many days?:')
        ...
        how_many = input('for how many weeks?:')
        for i in range(how_many):
            data_list = []
            y = datetime(int(date__[2]),int(date__[1]),int(date__[0]+7*i))
        ...
        for i in range(how_many):
            data_list = []
            y = datetime(int(date__[2]),int(date__[1]+1*i),int(date__[0]))

    elif answer == 5:
        how_many = input('for how many years?:')
        for i in range(how_many):
            data_list = []
            y = datetime(int(date__[2]+1*i),int(date__[1]),int(date__[0]))
else:
...
print(í_Dag)
date__ = date_.split('/')
# x = datetime.date(date_[2],date_[1],date_[0])
print(x)
